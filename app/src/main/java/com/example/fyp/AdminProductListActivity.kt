        ...
        database.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                if (productList.isEmpty()) {
                    tvNoProducts.visibility = TextView.VISIBLE  // Show "No products available"
                    recyclerView.visibility = RecyclerView.GONE  // Hide RecyclerView
                } else {
                    tvNoProducts.visibility = TextView.GONE  // Hide message
                    recyclerView.visibility = RecyclerView.VISIBLE  // Show RecyclerView
                }
